...
watch(() => props.modelValue, value => { if (value && props.editData) Object.assign(form, props.editData); else if (!value) reset() })
watch(() => props.editData, value => { if (props.modelValue && value) Object.assign(form, value) })
</script>
