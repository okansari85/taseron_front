  ...
  <header class="sticky top-0 z-[999] flex w-full border-b border-gray-200 bg-white dark:border-gray-800 dark:bg-gray-900">
    <div class="flex w-full items-center justify-between px-4 py-3 lg:px-6 lg:py-4">
      ...
      <div class="flex items-center gap-2">
        ...
        <button class="flex h-10 w-10 items-center justify-center rounded-lg text-gray-500 hover:bg-gray-100 dark:text-gray-400 dark:hover:bg-white/5">
          <span class="text-lg">♧</span>
        </button>
...
const { isExpanded, isMobileOpen, toggle, toggleMobile } = useTailAdminSidebar()
