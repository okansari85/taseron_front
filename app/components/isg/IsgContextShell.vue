...
.isg-context-shell--location > .flex > aside { width: var(--location-sidebar-width); background-image: url('/images/abc.png') !important; background-repeat: no-repeat !important; background-size: auto 140% !important; background-position: center -60% !important; background-color: transparent !important; }
