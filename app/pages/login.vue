...
import { ref } from 'vue'
import { ArrowLeft, Eye, EyeOff, Mail, Lock } from '@lucide/vue'
...
const handleSubmit = () => {
  // Auth/Sanctum connection will be wired after the login package is selected.
}
</script>
...
<template>
  <main class="min-h-screen bg-white lg:grid lg:grid-cols-2">
      ...
      <div class="mx-auto flex w-full max-w-[500px] flex-1 items-center py-12 lg:py-16">
        <div class="w-full">
          ...
          <form class="space-y-6" @submit.prevent="handleSubmit">
            <div>
              ...
              <div class="relative">
                ...
                <input
                  ...
                  class="h-14 w-full rounded-lg border border-slate-300 bg-white pl-12 pr-4 text-sm text-slate-900 outline-none transition placeholder:text-slate-400 focus:border-indigo-500 focus:ring-4 focus:ring-indigo-500/10"
                />
              </div>
            </div>
            ...
            <div>
              ...
              <div class="relative">
                ...
                <input
                  ...
                  class="h-14 w-full rounded-lg border border-slate-300 bg-white pl-12 pr-12 text-sm text-slate-900 outline-none transition placeholder:text-slate-400 focus:border-indigo-500 focus:ring-4 focus:ring-indigo-500/10"
                />
                <button
                  type="button"
            ...
            <button
              type="submit"
              class="h-14 w-full rounded-lg bg-indigo-600 text-sm font-bold text-white shadow-sm transition hover:bg-indigo-700 focus:outline-none focus:ring-4 focus:ring-indigo-500/20"
            >
              Giriş Yap
            </button>
    ...
    <section class="relative hidden min-h-screen overflow-hidden bg-slate-950 lg:block">
      <img
        src="/images/taseron-login-workers.jpg"
        alt="Şantiye sahasında çalışan taşeron ekip"
      ...
      <div class="relative flex h-full min-h-screen items-center justify-center px-12 text-center">
        <div class="max-w-xl rounded-3xl bg-slate-950/20 px-8 py-10 backdrop-blur-[2px]">
          ...
          <h2 class="text-4xl font-bold tracking-tight text-white drop-shadow-sm xl:text-5xl">
            Taşeron Yönetimi
          </h2>
