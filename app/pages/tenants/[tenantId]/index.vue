...
<template>
  <div class="space-y-6 mx-auto w-full max-w-[1400px]">
    <div>
      ...
      <h1 class="text-2xl font-semibold text-gray-900 dark:text-white/90">
        {{ tenant?.name ?? 'Tenant Workspace' }}
      </h1>

      <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">
        Tenant çalışma alanına hoş geldiniz.
      </p>
    </div>
    ...
    >
      <div class="flex items-start gap-4">
        <div class="flex h-11 w-11 shrink-0 items-center justify-center rounded-xl bg-brand-50 text-brand-500 dark:bg-brand-500/10 dark:text-brand-400">
          <Building2 :size="20" />
        </div>
        ...
        <div>
          ...
          <h2 class="mt-1 text-lg font-semibold text-gray-900 dark:text-white/90">
