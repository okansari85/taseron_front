  ...
  <div v-if="modelValue" class="fixed inset-0 z-[1000] flex items-center justify-center bg-gray-900/40 p-4 backdrop-blur-[2px]">
    <div class="w-full max-w-2xl overflow-hidden rounded-2xl border border-gray-200 bg-white shadow-2xl dark:border-gray-800 dark:bg-gray-900">
      ...
      <div class="grid gap-4 p-5 sm:grid-cols-2">
        ...
        <label><span class="mb-1.5 block text-xs font-semibold text-gray-700 dark:text-gray-300">Faaliyet <span class="font-normal text-gray-400">(opsiyonel)</span></span><input v-model="contractorActivity" type="text" placeholder="Faaliyet" class="h-11 w-full rounded-lg border border-gray-200 bg-white px-3 text-sm text-gray-700 outline-none placeholder:text-gray-400 focus:border-brand-500 focus:ring-4 focus:ring-brand-500/10 dark:border-gray-700 dark:bg-gray-950 dark:text-white/90" /></label>
        <label><span class="mb-1.5 block text-xs font-semibold text-gray-700 dark:text-gray-300">Alt Faaliyet <span class="font-normal text-gray-400">(opsiyonel)</span></span><input v-model="contractorSubActivity" type="text" placeholder="Alt faaliyet" class="h-11 w-full rounded-lg border border-gray-200 bg-white px-3 text-sm text-gray-700 outline-none placeholder:text-gray-400 focus:border-brand-500 focus:ring-4 focus:ring-brand-500/10 dark:border-gray-700 dark:bg-gray-950 dark:text-white/90" /></label>
        <label><span class="mb-1.5 block text-xs font-semibold text-gray-700 dark:text-gray-300">SGK Sicil No <span class="font-normal text-gray-400">(opsiyonel)</span></span><input v-model="contractorSgk" type="text" placeholder="SGK sicil numarası" class="h-11 w-full rounded-lg border border-gray-200 bg-white px-3 text-sm text-gray-700 outline-none placeholder:text-gray-400 focus:border-brand-500 focus:ring-4 focus:ring-brand-500/10 dark:border-gray-700 dark:bg-gray-950 dark:text-white/90" /></label>
        <label><span class="mb-1.5 block text-xs font-semibold text-gray-700 dark:text-gray-300">NACE Kodu <span class="font-normal text-gray-400">(opsiyonel)</span></span><input v-model="contractorNace" type="text" placeholder="Örn. 81.21.01" class="h-11 w-full rounded-lg border border-gray-200 bg-white px-3 text-sm text-gray-700 outline-none placeholder:text-gray-400 focus:border-brand-500 focus:ring-4 focus:ring-brand-500/10 dark:border-gray-700 dark:bg-gray-950 dark:text-white/90" /></label>
