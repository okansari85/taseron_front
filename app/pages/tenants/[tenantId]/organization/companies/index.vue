  ...
  <div class="font-outfit">
    <div class="mx-auto w-full max-w-[1400px]">
      ...
      <section class="overflow-hidden rounded-xl border border-gray-200 bg-white shadow-theme-xs dark:border-gray-800 dark:bg-white/[0.03]">
        <CompanyTable :companies="paginatedCompanies" :loading="loading" :error="error" @view="goToCompany" />
        <CompanyPagination v-model:page="currentPage" v-model:per-page="perPage" :total="filteredCompanies.length" :total-pages="totalPages" :visible-pages="visiblePages" />
      </section>
    </div>
  </div>
</template>
