    ...
    <div class="mx-auto w-full max-w-[1400px]">
      ...
      <div class="grid grid-cols-1 gap-5 xl:grid-cols-[minmax(0,1fr)_320px]">
        <section class="rounded-xl border border-gray-200 bg-white p-6 shadow-theme-xs dark:border-gray-800 dark:bg-white/[0.03]">
          <div class="mb-6">
            <h2 class="text-sm font-semibold text-gray-900 dark:text-white/90">Genel Bilgiler</h2>
          </div>
          ...
          <div>
            <h3 class="text-sm font-semibold text-gray-800 dark:text-white/90">Ebeveyn Grup</h3>
            <p class="mt-1 text-xs text-gray-400">Bu grup başka bir grubun altında yer alabilir. Üst seviye grup oluşturuyorsanız boş bırakın.</p>
          ...
          <div class="mt-5 flex gap-3 rounded-lg border border-brand-100 bg-brand-50/60 px-4 py-3 dark:border-brand-500/20 dark:bg-brand-500/5">
            <Info :size="17" class="mt-0.5 shrink-0 text-brand-500" />
            <p class="text-xs leading-5 text-gray-600 dark:text-gray-300">
              Üst seviye grup doğrudan <span class="font-semibold text-brand-600 dark:text-brand-400">{{ tenant.name }}</span> altında yer alır.
            </p>
          </div>
        </section>
        ...
        <div class="space-y-5">
          <section class="rounded-xl border border-gray-200 bg-white p-6 shadow-theme-xs dark:border-gray-800 dark:bg-white/[0.03]">
            <h2 class="text-sm font-semibold text-gray-900 dark:text-white/90">Durum</h2>
            <div class="mt-5">
              <div class="text-sm font-medium text-gray-700 dark:text-gray-300">Aktif Durumu</div>
              <button type="button" class="mt-3 flex items-center gap-3" @click="isActive = !isActive">
                ...
                <span class="text-sm font-medium text-gray-700 dark:text-gray-300">{{ isActive ? 'Aktif' : 'Pasif' }}</span>
              </button>
      ...
      <section class="mt-5 rounded-xl border border-brand-100 bg-brand-50/50 px-5 py-4 dark:border-brand-500/20 dark:bg-brand-500/5">
        <div class="flex gap-3">
          <Info :size="18" class="mt-0.5 shrink-0 text-brand-500" />
          <div>
            <h3 class="text-sm font-semibold text-brand-600 dark:text-brand-400">Bilgilendirme</h3>
