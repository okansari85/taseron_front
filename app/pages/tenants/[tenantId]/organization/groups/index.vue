    ...
    <div class="mx-auto w-full max-w-[1400px]">
      ...
      <section class="mb-5 rounded-xl border border-gray-200 bg-white p-3 shadow-theme-xs dark:border-gray-800 dark:bg-white/[0.03]">
        <div class="grid grid-cols-1 gap-3 md:grid-cols-[minmax(220px,1.2fr)_1fr_1fr_auto]">
          ...
          <label class="relative block">
            <span class="pointer-events-none absolute left-3 top-1.5 text-[9px] font-medium text-gray-400">
              Durum
            </span>
            <select
            ...
            <ChevronDown :size="15" class="pointer-events-none absolute right-3 top-1/2 translate-y-0.5 text-gray-400" />
          </label>
        ...
        <div class="overflow-x-auto">
          <table class="min-w-[900px] w-full text-left">
            <thead class="border-b border-gray-100 bg-gray-50/70 dark:border-gray-800 dark:bg-white/[0.02]">
              <tr>
                <th class="px-4 py-3 text-[10px] font-semibold uppercase tracking-wide text-gray-500">Grup Adı</th>
                <th class="px-4 py-3 text-[10px] font-semibold uppercase tracking-wide text-gray-500">Ebeveyn Grup</th>
                <th class="px-4 py-3 text-[10px] font-semibold uppercase tracking-wide text-gray-500">Açıklama</th>
                <th class="px-4 py-3 text-[10px] font-semibold uppercase tracking-wide text-gray-500">Durum</th>
                <th class="px-4 py-3 text-[10px] font-semibold uppercase tracking-wide text-gray-500">Oluşturulma Tarihi</th>
                <th class="px-4 py-3 text-right text-[10px] font-semibold uppercase tracking-wide text-gray-500">İşlemler</th>
              </tr>
            </thead>
            ...
            <tbody class="divide-y divide-gray-100 dark:divide-gray-800">
              ...
              >
                <td class="px-4 py-3.5">
                  ...
                  >
                    <span class="flex h-8 w-8 shrink-0 items-center justify-center rounded-lg bg-brand-50 text-xs font-semibold text-brand-500 dark:bg-brand-500/10 dark:text-brand-400">
                      {{ groupInitial(group.name) }}
                    </span>
                    <span class="min-w-0">
                      <span class="block truncate text-xs font-semibold text-gray-800 dark:text-white/90">
                        {{ group.name }}
                      </span>
                      <span class="mt-0.5 block text-[10px] text-gray-400">
                        {{ group.code }}
                      </span>
                    </span>
                  </button>
                ...
                <td class="max-w-[250px] px-4 py-3.5 text-xs leading-5 text-gray-500 dark:text-gray-400">
                  {{ group.description }}
                </td>
                ...
                <td class="px-4 py-3.5">
                  <div class="flex items-center justify-end gap-2">
                    <button
                      type="button"
                      class="text-xs font-medium text-gray-600 transition hover:text-brand-500 dark:text-gray-400 dark:hover:text-brand-400"
                      @click="goToGroup(group.id)"
                    >
                      Görüntüle
                    </button>
        ...
        <div class="flex flex-col gap-3 border-t border-gray-100 px-4 py-3.5 sm:flex-row sm:items-center sm:justify-between dark:border-gray-800">
          ...
          <label class="relative self-start sm:self-auto">
            <select
              ...
              class="h-8 appearance-none rounded-lg border border-gray-200 bg-white pl-3 pr-8 text-[10px] text-gray-600 outline-none dark:border-gray-700 dark:bg-gray-900 dark:text-gray-400"
            >
              <option :value="10">10 / sayfa</option>
              <option :value="25">25 / sayfa</option>
              <option :value="50">50 / sayfa</option>
            </select>
            <ChevronDown :size="13" class="pointer-events-none absolute right-2 top-1/2 -translate-y-1/2 text-gray-400" />
          </label>
        </div>
      </section>
      ...
      <section class="mt-5 rounded-xl border border-brand-100 bg-brand-50/50 px-4 py-3.5 dark:border-brand-500/20 dark:bg-brand-500/5">
        <div class="flex items-start gap-3">
          ...
          <div>
            <h2 class="text-xs font-semibold text-brand-600 dark:text-brand-400">
              Bilgilendirme
            </h2>
            <p class="mt-1 text-[10px] leading-5 text-gray-500 dark:text-gray-400">
