<template>
  ...
  >
    ...
    >
      ...
      <v-row
        class="tenant-table-footer ma-0"
        align="center"
      >
        <v-col
          cols="4"
...
const pageCount = computed(() => {
  if (!search.value && !statusFilter.value && !structureFilter.value && !dateFilter.value) {
    return 3
  }
...
.tenant-table .v-table__wrapper > table {
  table-layout: fixed;
}
