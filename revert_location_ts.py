...
old_type = """export type LocationBusinessEntityBrand = {
  id: number
  name: string
  logoUrl: string
}
...
new_type = """export type LocationBusinessEntity = {
  id: number
  companyName: string
  brandName?: string
  logoUrl: string
}"""
assert old_type in s, 'type pattern not found (already reverted?)'
...
assert old_map in s, 'map pattern not found (already reverted?)'
